...
#define __ADI_MW_AXISTREAM_DMA__
	...
	#define ADI_MM2S_AXIS_DATAWIDTH <0x40>
	#define ADI_S2MM_AXIS_DATAWIDTH <0x40>
#elif defined(MW_DATAWIDTH_SELECT) && MW_DATAWIDTH_SELECT == 128
	#define ADI_MM2S_AXIS_DATAWIDTH <0x80>
	#define ADI_S2MM_AXIS_DATAWIDTH <0x80>
#else
	...
	#define ADI_MM2S_AXIM_DATAWIDTH <0x80>
	#define ADI_S2MM_AXIM_DATAWIDTH <0x80>
#else
