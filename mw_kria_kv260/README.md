### Petalinux project creation and Linux image build for AMD Kria KV260 Robotics Starter Kit
...
3. Add the meta-mathworks submodule:  			git submodule add https://github.com/mathworks/meta-mathworks mw_kria_kv260/project-spec/meta-mathworks
4. Copy the mw_kv260.patch to the path:			Petalinux/mw_kria_kv260/project-spec/meta-mathworks
5. Apply the patch by navigating to the above path:	git apply mw_kv260.patch 
...
3. Navigate to Petalinux project path:			Petalinux/mw_kria_kv260/
...
The name of the dtb overlay file is dependent on the bitstream file. Both the file names should be in sync as these should be loaded on to the target kit. The name of the bitstream file generated for KV260 using HDL Coder Default system refernece design is system_wrapper.bit
