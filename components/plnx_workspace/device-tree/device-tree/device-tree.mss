...
BEGIN OS
 ...
 PARAMETER periph_type_overrides = {BOARD zcu111-reva }
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_dma_mm2s
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_dma
 PARAMETER HW_INSTANCE = axi_dma_rfdc_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_dma
 PARAMETER HW_INSTANCE = axi_dma_s2mm
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER HW_INSTANCE = passthru_ip_0
END
