...
BEGIN OS
 ...
 PARAMETER periph_type_overrides = {BOARD zcu216-reva}
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = ADC_DDR_DMA_axi_dma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER HW_INSTANCE = ADC_DDR_DMA_axis_inter_adc_xbar
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mig_7series
 PARAMETER HW_INSTANCE = ADC_DDR_DMA_ddr4_adc
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER HW_INSTANCE = ADC_DDR_DMA_tlast_gen_v1_0_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_dma
 PARAMETER HW_INSTANCE = DAC_DDR_DMA_axi_dma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mig_7series
 PARAMETER HW_INSTANCE = DAC_DDR_DMA_ddr4_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER HW_INSTANCE = PS_Subsystem_axi_gpio_dac
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER HW_INSTANCE = PS_Subsystem_axi_gpio_mts
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER HW_INSTANCE = PS_Subsystem_axi_gpio_spi_mux
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_clk_wiz
 PARAMETER HW_INSTANCE = clocking_block_clk_wiz_adc0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_clk_wiz
 PARAMETER HW_INSTANCE = clocking_block_clk_wiz_adc1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_clk_wiz
 PARAMETER HW_INSTANCE = clocking_block_clk_wiz_adc2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_clk_wiz
 PARAMETER HW_INSTANCE = clocking_block_clk_wiz_adc3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_clk_wiz
 PARAMETER HW_INSTANCE = clocking_block_clk_wiz_dac0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_clk_wiz
 PARAMETER HW_INSTANCE = clocking_block_clk_wiz_dac1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_clk_wiz
 PARAMETER HW_INSTANCE = clocking_block_clk_wiz_dac2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_clk_wiz
 PARAMETER HW_INSTANCE = clocking_block_clk_wiz_dac3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER HW_INSTANCE = ex_design_adc_sink_i
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER HW_INSTANCE = ex_design_dac_source_i
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = rfdc
 PARAMETER HW_INSTANCE = ex_design_rfip
END
