...
usage() {
    ...
    echo ""
    echo "Example:"
    echo "$0 /home/$USER/petalinux/2021.2 /home/$USER/xilinx-zcu111-2021.2"
}
...
if [ -d "$METAMWDIR" ]; then
    ...
    git clone -b petalinux-v2021.2 https://github.com/mathworks/meta-mathworks.git "$METAMWDIR"
fi

cp ./0001-zcu111-fixes.patch $METAMWDIR
cd $METAMWDIR
...
echo "Packaging Image"
	...
	cp $DIR/mw_utils/rftool_zcu111 $SD_DIR/rftool_zcu111
